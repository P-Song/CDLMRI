...
% sampling_factor = 1/5; % sampling_factor = m/n; m: number of measurements; n: image dimensions
% sampling_factor = 1/10; % sampling_factor = m/n; m: number of measurements; n: image dimensions
sampling_factor = 1/15; 
